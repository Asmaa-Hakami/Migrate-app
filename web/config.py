...
class BaseConfig:
    DEBUG = True
    POSTGRES_URL = "migrate-app-project3.postgres.database.azure.com"  # TODO: Update value
    POSTGRES_USER = "Asmaa@migrate-app-project3"  # TODO: Update value
    POSTGRES_PW = "project#3"  # TODO: Update value
